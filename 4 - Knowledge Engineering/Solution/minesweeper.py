...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        knowledge_altered = True
        while knowledge_altered:
            knowledge_altered = False
            knowledge = copy.copy(self.knowledge)
            for sentence in knowledge:
                mine_cells = copy.copy(sentence.known_mines())
                for cell in mine_cells:
                    knowledge_altered = True
                    self.mark_mine(cell)

                safe_cells = copy.copy(sentence.known_safes())
            ...
            for s1 in knowledge:
                for s2 in knowledge:
                    ...
                    if s1.cells in s2.cells:
                        knowledge_altered = True
                        self.knowledge.append(Sentence(s1.cells.intersection(s2.cells), abs(s1.count-s2.count)))
